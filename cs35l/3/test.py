...
class randline:
    def __init__(self, filename, unique, w_r, numlines):
        self.lines = []
        self.w_r=w_r
        ...
        if length<numlines and w_r:
            sys.stdout.write("you are asking for more lines than are in the input\n")
            sys.exit()
...
Output randomly selected lines from FILE."""
    ...
    try:
        generator = randline(input_file, options.unique, options.w_r, int(options.numlines))
